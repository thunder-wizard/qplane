...
class QLearn():
    ...
    def __init__(self, n_stat, n_acts, gamm, lr, eps, dec, min, epsDecay, expName, saveForAutoReload, loadModel, usePredefinedSeeds, loadModel, inputs, minReplay, replay, batch, update, stateDepth):
        ...
        self.model = DQNAgent(inputs, self.n_actions, self.learningRate,
                              minReplay, replay, batch, self.gamma, update, loadModel, loadModel, stateDepth)
...
class DQNAgent:
    def __init__(self, inputs, outputs, learningRate, minReplay, replay, batch, gamma, update, loadModel, loadModel, stateDepth):
